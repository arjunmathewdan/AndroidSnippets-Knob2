...
import com.example.rotaryknob.RoundKnobButton.RoundKnobButtonListener;
...
****************************************************************************/
public class RotaryKnob extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        RoundKnobButton rv = new RoundKnobButton(this, R.drawable.statorplay, R.drawable.statorpause, R.drawable.rotoron, R.drawable.rotoroff, 
        ...
        rv.SetListener(new RoundKnobButtonListener() {
			public void onStateChange(boolean newstate) {
				//Toast.makeText(RotaryKnob.this,  "New state:"+newstate,  Toast.LENGTH_SHORT).show();
			}
